...
import { deleteKaradumanById, getAllKaradumanProducts } from '../../../../api/karadumanRequests'
import Swal from 'sweetalert2'
import PRODNAV from '../prod-nav-admin'

const KaradumanKalipADMIN = () => {
        ...
        function handleDelete(_id){
          ...
          swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
              deleteKaradumanById(_id)
              setKaradumanProducts(karadumanProducts.filter((x)=>x._id!=_id));
              swalWithBootstrapButtons.fire(
                'Deleted!',
        ...
        <Grid className='grid' container spacing={{ xs: 12, sm:6, md:4, lg:3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
          ...
          <div className='ekin-card'>
            ...
            <div className='prod-buttons'>
             ...
             <Button onClick={()=>handleDelete(karadumanProduct._id)} variant='contained' color='error'>DELETE</Button>
            </div>
          </div>
         </Grid>
         })}
...
export default KaradumanKalipADMIN
